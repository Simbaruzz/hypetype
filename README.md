...
### Автотипограф
Чтобы использовать Автотипограф, выделите текст и нажмите Alt+Backspace. Ёфикатор опционально можно включить или выключить в выпадающем меню.
Атоматически исправит и отформатирует выделенный текст на основе правил типографики, которые важны для автора, и заменяет букву «е» на «ё» в словах, где она должна употребляться. Подключение внешних словарей ёфикаторов — если соберём 10 запросов (на 20 июня 2025 количество запросов 1 шт ).
