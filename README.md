...
- без конфликтов со стандартными сочетаниями клавиш в других программах
 ...
 ![hypetype-preview-test](https://s13.gifyu.com/images/SXY0Y.gif)
...
### Эмодзи · каомодзи 
Да — будет работать. Выглядеть может максимально криво, но работать будет. Эмодзи, соответственно, работают как лапочки ^_^ 
