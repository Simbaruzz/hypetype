...
**04 · Сколько стоит?**
> По логике автора — каждый решает самостоятельно. Программа распространяется по модели Donationware: хочешь — поддерживаешь, не хочешь — не поддерживаешь. [Закинуть↗](https://boosty.to/simbarus/donate)
